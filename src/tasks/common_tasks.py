...
import src.tasks.task03 as task03
...
import src.tasks.task08 as task08
import src.tasks.task10 as task10
...
def get_unsolved_tasks():
    return {
        ...
        11: "[Необязательная]" + "[Трёхмерная]" + " Решение эллиптической задачи сеточным методом.",
